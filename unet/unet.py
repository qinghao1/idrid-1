...
class myUnet(object):
	...
	def __init__(self, img_rows = img_h, img_cols = img_w):
	...
	def train(self):
		...
		print('Fitting model...')
		model.fit(x=imgs_train, y=imgs_mask_train, batch_size=4, nb_epoch=10, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
